...
1. Add required-query or other input-backed GET smoke coverage for `/v1/admin/cache/stats`, `/monitoring/api/v1/providers`, `/api/v1/applications/documents/export`, and `/ai-gateway/s3/s3/list` once their safe request inputs are characterized.
